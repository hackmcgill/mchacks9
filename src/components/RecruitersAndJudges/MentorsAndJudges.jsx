...
const MentorsAndJudges = ({ scrollRef }) => {
    return (
        <div ref={scrollRef}>
            ...
            <DynamicGrid>
                <div className="grid">
                    <Individual image={Mostafa} name="Mostafa Shabka (Judge)" position="Senior Manager" companyName="Huawei"/>
                    <Individual image={Amy} name="Amy Pollard (Judge)" position="PM" companyName="OVHcloud"/>
                    <Individual image={Loreina} name="Loreina Chew (Mentor)" position="Product Designer" companyName="Twilio"/>
                    <Individual image={JinLin} name={`Jin Lin (Mentor)`} position="SWE" companyName="Google"/>
                    <Individual image={MikeWelsh} name="Michael Welsh (Mentor)" position="Principal engineer" companyName="Ritual"/>
                    <Individual image={Fred} name="Fred DeSerres (Mentor)" position="Backend engineer" companyName="Ritual"/>
