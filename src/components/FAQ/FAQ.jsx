...
import topGradient from "./top-gradient.svg"

const FAQ = ({ scrollRef }) => (
  <Container ref={scrollRef}>
    <img src={topGradient} id="top-gradient"/>
    <Window>
      <div className="content">
        ...
        <div className="grid">
          ...
          <Question question="When is McHacks?">
            ...
            start on Friday at 7pm and end on Sunday at 2:30pm Eastern time on
            the weekend of January 29-31.
          </Question>
